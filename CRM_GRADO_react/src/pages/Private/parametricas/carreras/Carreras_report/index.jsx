...
//endJSunidad_academica
//initJSnombre_carrera
{ _id: "nombre_carrera", name: "Carrera" },
//endJSnombre_carrera
//initJSid_saga_carrera
{ _id: "id_saga_carrera", name: "Id Saga" },
    ...
    function downloadPDF() {
        ...
        doc.html(divContents, {
            callback: function (doc) {
                ...
                const nombreArchivo = `Reporte_Carreras_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}.pdf`;
...
//endJSunidad_academica
//initJSnombre_carrera
if (camposSeleccionados.includes("nombre_carrera")) r.nombre_carrera = i?.nombre_carrera;
//endJSnombre_carrera
//initJSid_saga_carrera
if (camposSeleccionados.includes("id_saga_carrera")) r.id_saga_carrera = i?.id_saga_carrera;
//endJSid_saga_carrera
//camposExcel
        ...
        const fechaActual = new Date();
        const nombreArchivo = `Reporte_Carreras_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}`;
            ...
            <div className="px-2 py-1 sm:py-2 xl:py-4">
                <div className="bg-gray-50 px-1 py-0.5 sm:py-0.5 2xl:py-1 sm:flex flex flex-wrap-reverse sm:items-center w-full">
                    <div className="sm:flex-auto">
                        <h1 className="text-balance 2xl:text-xl sm:text-lg text-sm mt-2 sm:mt-0 font-semibold text-gray-900 uppercase">Reporte de Carreras</h1>
                    </div>
...
//initJSnombre_carrera
{ id: "nombre_carrera", name: "Carrera", type: "string" },
//endJSnombre_carrera//search
//initJSid_saga_carrera
{ id: "id_saga_carrera", name: "Id Saga", type: "string" },
//endJSid_saga_carrera//search
//fieldsSearch
                    ...
                    <div ref={htmlReport} className="printable-page">
                        <div className="report-header">
                            <div scope="colgroup" className="flex relative isolate font-semibold border-b border-gray-200 bg-gray-50">
                                ...
                                <label className="grow text-xs sm:text-sm 2xl:text-lg py-4 uppercase">Reportes Carreras</label>
...
{camposSeleccionados.includes("unidad_academica") && <td>{carreras?.unidad_academica?.nombre_unidad_academica}</td>}
{/* endJSXunidad_academica */}
{/* initJSXnombre_carrera */}
{camposSeleccionados.includes("nombre_carrera") && <td>{carreras?.nombre_carrera}</td>}
{/* endJSXnombre_carrera */}
{/* initJSXid_saga_carrera */}
{camposSeleccionados.includes("id_saga_carrera") && <td>{carreras?.id_saga_carrera}</td>}
{/* endJSXid_saga_carrera */}
{/* camposTabla */}
                                            {camposSeleccionados.includes("last_user") && <td className="2xl:px-3 sm:px-2 px-1 2xl:py-4 sm:py-2 py-1 2xl:text-sm text-xs text-gray-500">{carreras?.last_user?.name}</td>}
                                            {camposSeleccionados.includes("createdAt") && <td className="2xl:px-3 sm:px-2 px-1 2xl:py-4 sm:py-2 py-1 2xl:text-sm text-xs text-gray-500">{new Date(carreras?.createdAt).toLocaleString("es-ES")}</td>}
                                            {camposSeleccionados.includes("updatedAt") && <td className="2xl:px-3 sm:px-2 px-1 2xl:py-4 sm:py-2 py-1 2xl:text-sm text-xs text-gray-500">{new Date(carreras?.updatedAt).toLocaleString("es-ES")}</td>}
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
...
export default Carreras_report;