...
{ name: "Unidad Academica", field: "unidad_academica_mensaje" },
//endJSunidad_academica_mensaje
//initJSbanner
{ name: "Banner", field: "banner" },
//endJSbanner
//headers
];
function Mensajeria_list() {
            ...
            <div className="px-2  py-1 sm:py-2 xl:py-4 ">
                <div className="bg-gray-50 px-1  py-0.5 sm:py-0.5 2xl:py-1  sm:flex flex flex-wrap-reverse sm:items-center w-full">
                    <div className="sm:flex-auto">
                        <h1 className="text-balance 2xl:text-xl sm:text-lg text-sm  mt-2 sm:mt-0 font-semibold text-gray-900 uppercase">Lista de Mensajeria</h1>
                    </div>
                    <div className="ml-6 sm:ml-0 flex-none">
                        {store.checkPermissions(['create_mensajeria']) &&
                            <Link
                                to="../mensajeria/create"
                                type="button"
                    ...
                    <div className="inline-block max-w-full min-w-full align-middle">
                        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-4 py-5 sm:flex-nowra">
                            <div className="flex items-center">
                                {store.checkPermissions(['report_mensajeria']) &&
                                    <Link
                                        to="../mensajeria/report"
                                        type="button"
                                        className="inline-flex items-center justify-center rounded-md border border-transparent bg-green-600 2xl:px-4 lg:px-2  py-2 2xl:text-sm sm:text-xs text-xs font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:w-auto"
                                    >
...
<td className="2xl:px-3 sm:px-2 px-1 2xl:py-4 sm:py-2 py-1 2xl:text-sm text-xs text-gray-500">{mensajeria?.unidad_academica_mensaje?.nombre_unidad_academica}</td>
{/* endJSXunidad_academica_mensaje */}
{/* initJSXbanner */}
            <td className="px-3 py-4 text-sm text-gray-600" style={{
...
{/*fields*/}
                                                <td className="absolute py-4 pl-3 pr-4 text-sm font-medium">
                                                    <OptionsRUD id={mensajeria._id} model="mensajeria" permissions={permissions} />
                                                </td>
                                            </tr>
                                        )) :
                                        <tr>
...
export default Mensajeria_list;