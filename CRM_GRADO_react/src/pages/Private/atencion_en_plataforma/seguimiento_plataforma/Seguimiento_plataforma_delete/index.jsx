...
import './Seguimiento_plataforma_delete.css';
import client from "@/api";
export default function Seguimiento_plataforma_delete() {
    //essentials
    const { id } = useParams();
...
//foreigns
    ...
    function deleteSeguimiento_plataforma() {
        store.setLoading(true);
        client.delete(`/seguimiento_plataforma/delete/${id}`).then(r => {
            store.showSuccess({ message: "Registro Eliminado", redirect: "/dashboard/seguimiento_plataforma/list", navigate });
        }).catch(e => {
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="bg-gray-50 px-4 py-3 rounded-lg border-gray-200 border sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        <h1 className="text-xl font-semibold text-gray-900 uppercase">ELIMINAR Seguimiento plataforma</h1>
                    </div>
                ...
                <div className="sm:mt-3 2xl:mt-4 mt-1  px-4 py-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="mt-5">
                        <button type="button" onClick={deleteSeguimiento_plataforma} className="text-lg inline-flex items-center justify-center px-4 py-2 border border-transparent font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm">
                            Eliminar Seguimiento plataforma
                        </button>
                    </div>
