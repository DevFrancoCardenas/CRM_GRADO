...
export default function Carreras_report({ modal, camposInit = [] }) {
    ...
    function downloadPDF() {
        ...
        doc.html(divContents, {
            callback: function (doc) {
                ...
                const nombreArchivo = `ReporteCarreras_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}.pdf`;
...
//camposExcel
        ...
        const fechaActual = new Date();
        const nombreArchivo = `ReporteCarreras_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}`;
        ...
        <>
            <IonHeader>
                <IonToolbar>
                    ...
                    <IonTitle>Reporte de Carreras</IonTitle>
                </IonToolbar>
            </IonHeader>
...
{/* camposTabla */}
                                        {camposSeleccionados.includes("last_user") && <td>{carreras?.last_user?.name}</td>}
