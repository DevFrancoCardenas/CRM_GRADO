...
import Carreras_report from "./Carreras_report";
const docForPage = 50;
export default function Carreras_list() {
...
//foreigns
    ...
    useEffect(() => {
        ...
        temp.create = store.checkPermissions(["create_carreras"]);
    ...
    return (
        <Page title="Lista de Carreras" createURL={permissions.create ? "/app/carreras/create" : null} permissions="read_carreras">
            ...
            <IonList className="w-full">
                {list.map((carreras, index) => (
                    <React.Fragment key={index}>
                        <IonItem routerLink={`/app/carreras/detail/${carreras._id}`} routerDirection="forward">
...
<p><span className="font-semibold">Carrera:</span>{carreras?.nombre_carrera}</p>
...
{/* fields */}
            ...
            <IonModal ref={modal} trigger="open-report">
                <Carreras_report modal={modal} camposInit={[
                    //camposDefault
                ]} />
            </IonModal>
        </Page>
