...
export default function Mensajeria_report({ modal, camposInit = [] }) {
    ...
    function downloadPDF() {
        ...
        doc.html(divContents, {
            callback: function (doc) {
                ...
                const nombreArchivo = `ReporteMensajeria_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}.pdf`;
...
//camposExcel
        ...
        const fechaActual = new Date();
        const nombreArchivo = `ReporteMensajeria_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}`;
        ...
        <>
            <IonHeader>
                <IonToolbar>
                    ...
                    <IonTitle>Reporte de Mensajeria</IonTitle>
                </IonToolbar>
            </IonHeader>
...
{/* endJSXbanner */}
{/* camposTabla */}
                                        {camposSeleccionados.includes("last_user") && <td>{mensajeria?.last_user?.name}</td>}
